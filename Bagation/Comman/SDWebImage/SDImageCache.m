...
- (void)storeImageDataToDisk:(nullable NSData *)imageData forKey:(nullable NSString *)key {
    ...
    if (![self->_fileManager fileExistsAtPath:_diskCachePath]) {
        [self->_fileManager createDirectoryAtPath:_diskCachePath withIntermediateDirectories:YES attributes:nil error:NULL];
    }
    ...
    [self->_fileManager createFileAtPath:cachePathForKey contents:imageData attributes:nil];
