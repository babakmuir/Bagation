...
public class TimelineView: UIView, ReusableView {
  ...
  override public func draw(_ rect: CGRect) {
    ...
    let attributes = [NSAttributedStringKey.paragraphStyle as NSString: paragraphStyle,
                      NSAttributedStringKey.foregroundColor as NSString: self.style.timeColor,
                      NSAttributedStringKey.font as NSString: style.font] as [NSAttributedStringKey : Any]
    ...
    for (i, time) in times.enumerated() {
      ...
      let timeString = NSString(string: time)
        ...
        timeString.draw(in: timeRect, withAttributes: attributes as [NSAttributedStringKey : Any])
    }
  }
