...
class LocationManager: NSObject,CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        let dic: NSDictionary = ["lat":lastLocation?.coordinate.latitude ?? "","long":lastLocation?.coordinate.longitude ?? ""]
    ...
    func getLastLocation() -> CLLocation {
        ...
        if ((UserDefaults.standard.value(forKey: Constants.Key_UserLastLocation)) != nil) {
          let location = UserDefaults.standard.value(forKey: Constants.Key_UserLastLocation) as! NSDictionary
            let currentLat :CLLocationDegrees! = location.value(forKey: "lat") as? CLLocationDegrees
            let currentLong :CLLocationDegrees! = location.value(forKey: "long") as? CLLocationDegrees
            
            let loc = CLLocation.init(latitude: currentLat, longitude: currentLong)
            return loc
        }
